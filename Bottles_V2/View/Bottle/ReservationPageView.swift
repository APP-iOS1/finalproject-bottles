    ...
    var body: some View {
        NavigationStack {
            ...
            VStack {
                ...
                Button(action: {
                    ...
                    if check {
                        isShowing.toggle()
                        Task{
                            await reservationDataStore.createReservation(reservationData: ReservationModel(id: tempId, shopId: bottleReservations[0].shop, userId: userStore.user.email, reservedTime: "", pickUpTime: "", state: "예약접수", reservedBottles: []), reservedBottles: bottleReservations)
            ...
            .navigationDestination(isPresented: $isShowing) {
                ReservedView(reservationData: ReservationModel(id: tempId, shopId: bottleReservations[0].shop, userId: userStore.user.email, reservedTime: "", pickUpTime: "", state: "예약접수", reservedBottles: getReservedBottlesArray(bottleReservations: bottleReservations)))
