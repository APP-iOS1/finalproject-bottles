//
//  BottleShopTestModel.swift
//  Bottles_V2
//
//  Created by youngseo on 2023/02/06.
//
...
class BottleShopTestStore: Identifiable, ObservableObject {
    // 임의로 바틀 아이템 데이터 생성 (데이터 연동시 삭제)
    @Published var bottleItems: [BottleItem22] = [
